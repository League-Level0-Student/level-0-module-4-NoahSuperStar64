...
int Story1 = JOptionPane.showOptionDialog(null, "The capital city Hocolan is under siege by Queen Umbra's dark knights.\n You manage to escape the city walls. You have a few options here, so choose wisely.", "Capital falling", 0, JOptionPane.INFORMATION_MESSAGE, null,
			new String[] { "Charge back in and swordfight the knights", "Retreat for now", "Try and shoot the knights from a distance with your bow"}, null);
	if(Story1==0) {
	...
	JOptionPane.showOptionDialog(null, "You decide that a tactical retreat is the best option.\n Where do you end up?", "Bravely running away", 0, JOptionPane.INFORMATION_MESSAGE, null,
